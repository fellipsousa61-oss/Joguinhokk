...
const posicoes = [
    ...
    { id: 12, nome: "Contra a Parede", emoji: "🧱", desc: "Pura adrenaline. Ele ergue ela contra a parede, e ela prende as pernas na cintura dele. Pegada firme, rápida e cheia de tesão selvagem." },
    { id: 13, nome: "Anjo Caído", emoji: "👼", desc: "Uma variação do papai e mamãe onde ela joga as duas pernas para o mesmo lado, cruzando o corpo. Aperado, viciante e com muito estímulo." },
